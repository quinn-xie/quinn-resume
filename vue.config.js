module.exports = {
     ...
     */
    // 项目部署的基础路径,默认假设你的应用将会部署在域名的根部,
    // 例如 https://www.xxx.com/ 如果你的应用部署在一个子路径下, 需要在这里指定子路径。
    // 比如将你的应用部署在 https://www.xxx.com/my-app/ 那么将这个值改为 '/my-app/'
    baseUrl: "/", 
    // 构建好的文件输出位置
    outputDir: "dist", 
    ...
    devServer: {
        ...
        host: "0.0.0.0", // 局域网中其他设备访问我的服务，127.0.0.1即只有本地可以访问
        port: 8088,
        https: false,
